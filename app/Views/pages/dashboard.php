<div class="flex w-screen h-screen text-gray-400 bg-gray-900">
	...
	<!-- Component Start -->
    <div class="flex flex-col items-center w- pb-4 overflow-auto border-r border-gray-800 text-gray-500">
            ...
            <div class="flex flex-col flex-grow">
                <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-800">
                    ...
                    <button class="relative ml-2 text-sm focus:outline-none group">
                        ...
                        <div class="absolute right-0 flex-col items-start hidden w-40 mt-1 pb-1 bg-gray-800 border border-gray-800 shadow-lg group-focus:flex rounded-md">
                            <a class="w-full px-4 py-2 text-left hover:bg-gray-900 rounded-md" href="#">Menu Item 1</a>

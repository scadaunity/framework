...
<div class="w-full flex justify-center items-center h-screen bg-gray-200">
  <div class="max-w-md w-full bg-white p-6 space-y-10 bg-white rounded-xl drop-shadow-2xl">
    ...
    <form class="bg-white" method="post" action="<?php route('/autenticate') ?>">
      <?php csrf() ?>
      ...
      <div class="w-full flex justify-center items-center">
        <div class="w-1/2 flex justify-start items-center">
          <a href="<?php route('/forgot') ?>" class="text-sm ml-2 hover:text-emerald-700 cursor-pointer">Não lembro minha senha ?</a>
        </div>

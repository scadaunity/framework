...
<div class="w-full flex justify-center items-center h-screen bg-gray-200">
  <div class="bg-white dark:bg-gray-900 max-w-md w-full p-6 space-y-10 bg-white rounded-xl drop-shadow-2xl">
    ...
    <div class="w-full flex justify-center items-center">
        <h1 class="text-gray-800 font-bold text-2xl mb-1 dark:text-white">Entrar</h1>
    </div>
    ...
    <form class="bg-white dark:bg-gray-900" method="post" action="<?php route('/autenticate') ?>">
      ...
      <div class="flex items-center border-2 py-2 px-3 rounded-md mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
        </svg>
        <input class="ml-1 pl-1 w-full rounded-full outline-none" type="text" name="email" id="" placeholder="Email" />
      </div>


      <?php getFlash('password') ?>
      <div class="flex items-center border-2 py-2 px-3 rounded-md mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-4" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
        </svg>
        <input class="ml-1 pl-1 w-full rounded-full outline-none" type="text" name="password" id="" placeholder="Senha" />
      </div>

      <div>
        <label class="inline-flex items-center cursor-pointer">
          <input id="customCheckLogin" type="checkbox" class="form-checkbox border-0 rounded text-gray-400 ml-1 w-5 h-5 ease-linear transition-all duration-150">

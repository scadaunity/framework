<!-- component -->
  ...
  <div class="mx-auto shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800 w-full md:w-96 mt-10">
    ...
    <div class="w-full flex justify-center items-center">
        <h1 class="text-gray-800 font-bold text-2xl p-6 dark:text-white">Entrar</h1>
    </div>
    ...
    <form class="" method="post" action="<?php route('/autenticate') ?>">
      ...
      <div class="flex items-center border-2 dark:border-gray-700 py-2 px-3 rounded-md mb-4">
        ...
        <input class="w-full w-full outline-none text-gray-500 dark:bg-gray-800" type="text" name="email" id="" placeholder="Email" />
      </div>
